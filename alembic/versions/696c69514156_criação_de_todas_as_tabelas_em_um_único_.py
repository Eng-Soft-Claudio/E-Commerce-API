"""Criação de todas as tabelas em um único baseline

Revision ID: 696c69514156
Revises: 
Create Date: 2025-07-09 14:44:06.691279
...
def upgrade() -> None:
    ...
    sa.Column('title', sa.String(), nullable=False, comment='Usado como texto alternativo (alt) da imagem.'),
    sa.Column('image_url', sa.String(), nullable=False, comment='URL da imagem do banner.'),
    sa.Column('link_url', sa.String(), nullable=True, comment='URL opcional para onde o banner redireciona ao ser clicado.'),
    sa.Column('position', sa.Integer(), nullable=False, comment='Controla a ordem de exibição dos banners.'),
    sa.Column('is_active', sa.Boolean(), nullable=False, comment='Permite ativar ou desativar o banner sem deletá-lo.'),
